...
LABS=("Conditioning_Stability" "DataVisualization" "Differentiation" "DrazinInverse" "FacialRecognition" "ImageSegmentation" "LeastSquares_Eigenvalues" "LinearTransformations" "MatplotlibIntro" "NumpyIntro" "PageRank" "Profiling" "SVD_ImageCompression" "UnixShell1" "UnixShell2")
